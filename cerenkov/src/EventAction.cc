...
void EventAction::EndOfEventAction(const G4Event* evt) {
    ...
    anaMan->FillNtupleIColumn(5, 10, fA2W_Total);    
    anaMan->FillNtupleIColumn(5, 11, fA2C_Unique.size());
    anaMan->FillNtupleIColumn(5, 12, fA2C_Total);
    anaMan->FillNtupleIColumn(5, 13, fC2A_Total);       
    anaMan->FillNtupleIColumn(5, 14, fC2Sensor_Unique.size());
    anaMan->FillNtupleIColumn(5, 15, fSensorDetect_Unique.size());
