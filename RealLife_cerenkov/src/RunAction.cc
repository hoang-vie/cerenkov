...
RunAction::RunAction() : G4UserRunAction()
{
  ...
  anaMan->CreateNtupleIColumn("A2C_Unique");       // 10
  anaMan->CreateNtupleIColumn("A2C_Total");        // 11
  anaMan->CreateNtupleIColumn("C2Sensor_Unique");  // 12
  anaMan->CreateNtupleIColumn("Detected_Total");   // 13
