...
void DetectorConstruction::DefineMaterials()
{
  ...
  fAcrylic = nist->FindOrBuildMaterial("G4_POLYACRYLONITRILE"); // Hoặc G4_PLEXIGLASS tùy thư viện
  fCouplingMat = nist->FindOrBuildMaterial("G4_SILICON_DIOXIDE"); // Dummy khởi tạo
